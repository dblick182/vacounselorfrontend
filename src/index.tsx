...
const RepresentativeModalContent = ({ firstName, lastName, rep, onDismissModal }: { firstName: string, lastName: string, rep: IRepresentative, onDismissModal: () => void }) => {
  ...
  Representative ${rep.last_name}:
    ...
    The Government Accountability Office (GAO) investigated these issues within the VA VET Center Program from November 2019 to around August 2020, and they released their report on September 23, 2020 which substantiates these claims (https://www.gao.gov/products/GAO-20-652).  They also made recommendations for corrective action.
  ...
  1.	Maintaining the Clinical Visit Count and Performance Standards at a Reasonable and Ethically Compliant Level in the VA/VET Center Program with a Greater Emphasis on Quality Care and Counselor Well-Being.
